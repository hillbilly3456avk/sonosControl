...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.BT_sbb = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.BT_sbb.setFlat(True)
        self.BT_sbb.setObjectName("BT_sbb")
        self.TopSelectionBar.addWidget(self.BT_sbb)
        ...
        self.LB_welcomeText.setGeometry(QtCore.QRect(90, -10, 281, 41))
        self.LB_welcomeText.setObjectName("LB_welcomeText")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.SC_welcomeScreen)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 461, 251))
        ...
        self.LCD_day = QtWidgets.QLCDNumber(self.verticalLayoutWidget_3)
        self.LCD_day.setMaximumSize(QtCore.QSize(80, 16777215))
        self.LCD_day.setFocusPolicy(QtCore.Qt.NoFocus)
        self.LCD_day.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.LCD_day.setDigitCount(2)
        self.LCD_day.setProperty("value", 20.0)
        self.LCD_day.setObjectName("LCD_day")
        self.horizontalLayout_2.addWidget(self.LCD_day)
        self.LCD_month = QtWidgets.QLCDNumber(self.verticalLayoutWidget_3)
        self.LCD_month.setMaximumSize(QtCore.QSize(80, 16777215))
        self.LCD_month.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.LCD_month.setDigitCount(2)
        self.LCD_month.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
        self.LCD_month.setProperty("value", 7.0)
        self.LCD_month.setObjectName("LCD_month")
        self.horizontalLayout_2.addWidget(self.LCD_month)
        self.LCD_year = QtWidgets.QLCDNumber(self.verticalLayoutWidget_3)
        self.LCD_year.setMaximumSize(QtCore.QSize(140, 16777215))
        ...
        self.LCD_year.setProperty("value", 2017.0)
        self.LCD_year.setObjectName("LCD_year")
        self.horizontalLayout_2.addWidget(self.LCD_year)
        ...
        self.LCD_hour = QtWidgets.QLCDNumber(self.verticalLayoutWidget_3)
        self.LCD_hour.setMaximumSize(QtCore.QSize(80, 16777215))
        self.LCD_hour.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.LCD_hour.setDigitCount(2)
        self.LCD_hour.setSegmentStyle(QtWidgets.QLCDNumber.Flat)
        self.LCD_hour.setProperty("intValue", 14)
        self.LCD_hour.setObjectName("LCD_hour")
        self.horizontalLayout_3.addWidget(self.LCD_hour)
        spacerItem3 = QtWidgets.QSpacerItem(60, 20, QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem3)
        self.LCD_min = QtWidgets.QLCDNumber(self.verticalLayoutWidget_3)
        self.LCD_min.setMaximumSize(QtCore.QSize(80, 16777215))
        ...
        self.LCD_min.setProperty("intValue", 33)
        self.LCD_min.setObjectName("LCD_min")
        self.horizontalLayout_3.addWidget(self.LCD_min)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BT_sbb.setText(_translate("MainWindow", "SBB"))
