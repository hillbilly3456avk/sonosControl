...
class Ui_MainWindowTarget(object):
    ...
    def retranslateUi(self, MainWindowTarget):
        ...
        self.BT_musicMode.setText(_translate("MainWindowTarget", "Music"))
        self.BT_tvMode.setText(_translate("MainWindowTarget", "TV"))
        self.BT_radioMode.setText(_translate("MainWindowTarget", "Radio"))
