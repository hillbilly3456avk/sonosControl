...
class SonosInterface():
    ...
    def musicIcons(self, ui):
        ...
        ui.BT_sonosPlay.setStyleSheet("""background-color: #a8a0a0; padding: 0px; border: 0px solid black; margin: 0px; border-radius: 8px; max-width: 30px; min-height: 23px; color: #000000; image: url(path)""")
