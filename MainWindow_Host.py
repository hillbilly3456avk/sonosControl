...
class Ui_MainWindowHost(object):
    ...
    def retranslateUi(self, MainWindowHost):
        ...
        self.BT_musicMode.setText(_translate("MainWindowHost", "Music"))
        self.BT_radioMode.setText(_translate("MainWindowHost", "Radio"))
        self.BT_tvMode.setText(_translate("MainWindowHost", "TV"))
